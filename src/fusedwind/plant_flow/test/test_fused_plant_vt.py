import unittest
from fusedwind.plant_flow.fused_plant_vt import *
from fusedwind.plant_flow.fused_plant_comp import WeibullWindRose
...
wr_example = {
 'wind_directions': array([   0.,   30.,   60.,   90.,  120.,  150.,  180.,  210.,  240.,  270.,  300.,  330.]),
 ...
 'wind_speeds': array([  4.        ,   4.42857143,   4.85714286,   5.28571429,
