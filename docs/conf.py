...
# version = fusedwind.__version__
# The full version, including alpha/beta/rc tags.
# release = fusedwind.__version__
...
# Note: exts.numfig still causes crash and make has to be called twice to build html
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.mathjax', 'sphinx.ext.viewcode',
              ...
              'sphinxcontrib.zopeext.autointerface', 'sphinx.ext.intersphinx', 'sphinxcontrib.napoleon']
...
autoclass_content = 'both'  # include the init docstring rather than the class docstring
rst_prolog = """
.. role:: bib
   :class: bib
...
#html_sidebars = {}
html_sidebars = {'**': ['sidebar_versions.html', 'sidebar_toc.html']}
