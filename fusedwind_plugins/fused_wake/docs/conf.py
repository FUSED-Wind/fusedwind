...
_sys_path_add(['src', 'src/fused_wake', 'src/fused_wake/deprecated', 'src/fused_wake/test', 'src/fused_wake/test/unittest_ref_files', 'src/fused_wake/test/unittest_ref_files/NOJ'])
